...
var allKeyBindings = []KeyBinding{
	...
	{Key: "n", BarKey: "n", BarDesc: "Wktree", Desc: "New session (worktree-by-default, instant)", Section: "session"},
	...
	{Key: "p", BarKey: "p", BarDesc: "PR", Desc: "Open PR / MR in browser", Section: "session"},
